...
"}")
        ...
        icon = QIcon()
        icon.addFile(u":/images/icons/x-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/images/icons/video.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/images/icons/video.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon3 = QIcon()
        icon3.addFile(u":/images/icons/aperture.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.EvidenceBtn = QPushButton(self.frame_8)
        self.EvidenceBtn.setObjectName(u"EvidenceBtn")
        self.EvidenceBtn.setFont(font1)
        self.EvidenceBtn.setStyleSheet(u"QPushButton:enabled {\n"
"	color: white;\n"
"}\n"
"\n"
"QPushButton:pressed {\n"
...
"	color: rgb(167, 167, 167);\n"
"}")
        self.EvidenceBtn.setIconSize(QSize(40, 40))

        self.verticalLayout_5.addWidget(self.EvidenceBtn)
        ...
        self.EvidenceBtn.clicked.connect(self.rightMenuContainer.show)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"SERVICE FAULT BADMINTON DETECTION", None))
#if QT_CONFIG(tooltip)
        self.closeBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Close Window", None))
#endif // QT_CONFIG(tooltip)
        self.closeBtn.setText("")
        self.pushButton_11.setText("")
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"CAM 1", None))
        self.pushButton_9.setText("")
        self.pushButton_16.setText(QCoreApplication.translate("MainWindow", u"CAM 2", None))
        self.pushButton_12.setText("")
#if QT_CONFIG(shortcut)
        self.pushButton_12.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+S", None))
#endif // QT_CONFIG(shortcut)
#if QT_CONFIG(tooltip)
        self.EvidenceBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Capture", None))
#endif // QT_CONFIG(tooltip)
        self.EvidenceBtn.setText(QCoreApplication.translate("MainWindow", u"Evidence", None))
        self.label_15.setText(QCoreApplication.translate("MainWindow", u"Copyright Politeknik Negeri Madiun @2023", None))
        self.label_16.setText("")
    # retranslateUi

        self.EvidenceBtn.clicked.connect(self.openvideo)
