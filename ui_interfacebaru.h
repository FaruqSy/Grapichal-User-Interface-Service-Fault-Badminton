/********************************************************************************
** Form generated from reading UI file 'interfacebaruSUmzjP.ui'
**
...
#ifndef INTERFACEBARUSUMZJP_H
#define INTERFACEBARUSUMZJP_H
...
"}"));
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/icons/x-circle.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/images/icons/video.svg"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/images/icons/video.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/images/icons/aperture.svg"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_12->setIcon(icon3);
        pushButton_12->setIconSize(QSize(43, 43));

        verticalLayout_5->addWidget(pushButton_12);

        EvidenceBtn = new QPushButton(frame_8);
        EvidenceBtn->setObjectName(QStringLiteral("EvidenceBtn"));
        EvidenceBtn->setFont(font1);
        EvidenceBtn->setStyleSheet(QLatin1String("QPushButton:enabled {\n"
"	color: white;\n"
"}\n"
"\n"
"QPushButton:pressed {\n"
...
"	color: rgb(167, 167, 167);\n"
"}"));
        EvidenceBtn->setIconSize(QSize(40, 40));

        verticalLayout_5->addWidget(EvidenceBtn);
        ...
        QObject::connect(EvidenceBtn, SIGNAL(clicked()), rightMenuContainer, SLOT(show()));
...
#ifndef QT_NO_TOOLTIP
        EvidenceBtn->setToolTip(QApplication::translate("MainWindow", "Capture", nullptr));
#endif // QT_NO_TOOLTIP
        EvidenceBtn->setText(QApplication::translate("MainWindow", "Evidence", nullptr));
