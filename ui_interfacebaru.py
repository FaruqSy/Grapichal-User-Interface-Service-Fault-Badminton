...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/icons/aperture.svg", QSize(), QIcon.Normal, QIcon.Off)
...
#if QT_CONFIG(tooltip)
        self.EvidenceBtn.setToolTip(QCoreApplication.translate("MainWindow", u"Evidence", None))
#endif // QT_CONFIG(tooltip)
